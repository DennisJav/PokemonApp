    ...
    fun setPokemonData(pokemon : Pokemon){
        ...
        Glide.with(this).load(pokemon.imageUrl).listener(object : RequestListener<Drawable>{
            ...
            override fun onLoadFailed(
                ...
                imageView.setImageResource(R.drawable.image_not_supported)
                return false
            }
            ...
            //aqui se ejecutaria en caso de algun error con las imagenes
        }).error(R.drawable.image_not_supported).into(imageView);
